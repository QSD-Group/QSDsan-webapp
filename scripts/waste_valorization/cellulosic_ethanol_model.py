...
https://github.com/BioSTEAMDevelopmentGroup/Bioindustrial-Park/blob/master/biorefineries/cornstover/webapp_model.py
'''
...
if __name__ == '__main__':
    from lignocellulose import create_system
    sys = create_system()
